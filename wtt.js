...
var colors = ['brown','red','orange','yellow','#C2B280','green','#00FF00','#000080','blue','#00FFFF','purple','#FF0090',
'pink','black','gray','white','#F9F9F9'];
...
function categoriesList()
{
  ...
  htmlString += '<div class="wtb-hiddenCategoriesList"><label class="wtb-checkbox-container"><div class="wtb-singleoption" style="font-weight: 600; color: #FFAC0D;">Inne';
...
function brandsList()
{
  ...
  htmlString += '<div class="wtb-hiddenBrandsList"><label class="wtb-checkbox-container"><div class="wtb-singleoption" style="font-weight: 600; color: #FFAC0D;">Inne';
  htmlString += '</div><input type="checkbox"><span class="wtb-checkmark"></span></label></div>';
...
function colorsList()
{
  ...
  htmlString += '<div class="wtb-singlecw"><label><input type="checkbox"><div class="color" style="background-color:';
  htmlString += filters[5][15];
  htmlString += '; background:-webkit-linear-gradient(red, blue); "><div class="wtb-checkmark" style="border-color: white;"></div></div></label></div>';
...
$('#adwin-select-category').find('div.dropOption').first().css('background-color', '#191919');
...
var containerCategory = $('#adwin-select-category .dropContainer');
  ...
  $('#adwin-select-category').on('click', function(event)
  {
    ...
    else if(target.hasClass('dropOption'))
    {
      ...
      target.css('background-color', '#191919');
